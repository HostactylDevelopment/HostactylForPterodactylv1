/*You can add further changes yourself (Customization Allowed For Landing Page ONLY.)

Copyright (c) 2024 Hostactyl Development. All Rights Reserved.

The Hosting's Dashboard is Powered by Hostactyl

Removing these copyright message will result in a DMCA. */
...
app.listen(process.env.APP_PORT || 3000, () => {
  console.log(`Hostactyl has been started on ${process.env.APP_URL} !`);
});